...
function validateIdeaSet(ideas, request) {
  ...
  for (const idea of ideas) {
    ...
    if (dianaUnsupportedActivity.test(text)) {
      throw new Error('date-ai-diana-activity-mismatch');
    }
  }
...
function datePrompt(input) {
  ...
  return [
    ...
    'Учитывай личные интересы пары. Диана любит: экстрим, вкусную еду, выставки, театры, новые места, экскурсии, бары, кофейни, кино, рестораны, красивые и необычные нишевые места, поездки в другой город, аттракционы и мастер-классы.',
    'Важное ограничение: Диана не умеет кататься на велосипеде, самокате, роликах и коньках, а также не умеет плавать. Никогда не предлагай свидания, где ей нужно кататься на велосипеде/самокате/роликах/коньках, идти на каток, плавать, посещать бассейн или аквапарк ради водных активностей, кататься на SUP, каяке или байдарке. Обычная поездка на катере или теплоходе допустима, если плавать не требуется.',
    'Рустам любит: всё новое, поездки и катание на машине, вкусную еду, отдых, баню и живое общение с новыми людьми.',
    'Старайся в первую очередь находить пересечение их интересов. Хорошие сочетания: новое необычное место + еда; поездка на машине + интересная точка; выставка/театр/кино + кофейня или ресторан; мастер-класс + ужин; баня/спа + отдых; поездка в другой город + локальная еда или экскурсия.',
    'Не зацикливайся на одних и тех же интересах. В одной выдаче используй разные типы впечатлений, а в следующих генерациях меняй не только названия, но и сам формат свидания.',
    'Интерес Рустама к общению с новыми людьми можно учитывать через бары, мастер-классы, групповые экскурсии, события и другие социальные места, где знакомство может произойти естественно. Но свидание остаётся для Рустама и Дианы, и участие незнакомцев не должно быть обязательным условием сценария.',
