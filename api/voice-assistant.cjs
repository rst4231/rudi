  ...
  const messages = [
    {
      ...
      content: [
        ...
        'Никогда не возвращай служебные метки вроде <b>, <strong>, <br>. Никогда не показывай внутренние коды RUDI вроде joy, sadness, fear, anger, love — переводи их на естественный русский.',
