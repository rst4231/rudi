...
const RECOVERY_DATE = '2026-08-26';
const RECOVERY_KEY = 'events-recovery-20260826-complete';
const EXPECTED_KEY_HASH = '8c09eb7a108c22cdf6814353ad846b2a4866394458edbe62199131a5c9b72c46';
...
async function handler(req, res) {
  if (moscowDateKey() !== RECOVERY_DATE) {
    return res.status(410).json({ ok: false, error: 'events-recovery-expired' });
  }
