...
test('Lulu, weekend plans and the old standalone recipe system stay retired', () => {
  ...
  absent('public/index.html', [/Антидубли/i, /Футеры/i, /Источники контента/i, /lulu/i, /weekend/i]);
