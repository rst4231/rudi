...
+new Intl.NumberFormat('ru-RU',{minimumFractionDigits:digits,maxFractionDigits:digits}).format(num);
        }
        return new Intl.NumberFormat('ru-RU',{minimumFractionDigits:2,maxFractionDigits:2}).format(num)+' ₽';
      }
      ...
      function marketTickerChange(value){
        ...
        const sign=num>0?'+':'';
        return {
          text:sign+new Intl.NumberFormat('ru-RU',{minimumFractionDigits:1,maxFractionDigits:1}).format(num)+'%',
      ...
      function mergeMarketTickerPayload(fresh,cached){
        ...
        const order=['usd-rub','btcusdt','ethusdt'];
      ...
      async function loadMarketTicker({silent=false}={}){
        ...
        marketTickerLoadPromise=(async()=>{
          try{
            ...
            }else if(!cached) renderMarketTicker(null);
            return merged;
          }catch(error){
